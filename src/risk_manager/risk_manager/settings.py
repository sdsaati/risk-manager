...
SECRET_KEY = "django-insecure-te(^e!sxn#ebqzvs0=)17d#_h*+pt&a-+6^h-5@!$kn%y!$5*^"

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True
LOGGING = {
    "version": 1,
    "disable_existing_loggers": False,  # Don't disable already configured loggers
    "formatters": {
        "verbose": {
    ...
    "loggers": {
        "django": {
            "handlers": ["console", "file"],  # Handlers for this logger
